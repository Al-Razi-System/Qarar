...
-- Re-declare the user-facing route preview with UTF-8 Arabic messages.
-- The routing logic is unchanged; this replaces legacy mojibake literals.
...
begin
  ...
  where wv.id = v_option.workflow_template_version_id and wv.organization_id = v_org;
